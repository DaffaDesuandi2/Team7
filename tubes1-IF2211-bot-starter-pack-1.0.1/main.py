...
from game.logic.cintadm import CintaDamai
from game.logic.Sasuke import sasuke
from game.logic.Sakura import Sakura
from game.logic.Naruto import naruto

init()
BASE_URL = "http://localhost:3000/api"
DEFAULT_BOARD_ID = 1
CONTROLLERS = {
    "Random": RandomLogic, "MyBot": BertBots, "cintadm": CintaDamai, "sasuke": sasuke, "sakura" :Sakura, "naruto": naruto,
}
